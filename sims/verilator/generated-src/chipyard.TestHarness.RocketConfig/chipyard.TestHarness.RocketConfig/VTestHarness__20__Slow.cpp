...
void VTestHarness::_settle__TOP__1358(VTestHarness__Syms* __restrict vlSymsp) {
    ...
    WData/*95:0*/ __Vtemp3470[3];
    WData/*95:0*/ __Vtemp3471[3];
    // Body
    ...
    VL_EXTEND_WI(67,4, __Vtemp3470, (((IData)(vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__subsystem_l2_wrapper__DOT__l2__DOT__monitor__DOT___a_first_T) 
                                      ...
                                      ? (1U | ((IData)(vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__subsystem_l2_wrapper__DOT__InclusiveCache_inner_TLBuffer__DOT__bundleOut_0_a_q_io_deq_bits_opcode) 
                                               << 1U))
                                      : 0U));
    VL_SHIFTL_WWI(67,67,6, __Vtemp3471, __Vtemp3470, 
...
void VTestHarness::_settle__TOP__1359(VTestHarness__Syms* __restrict vlSymsp) {
    ...
    // Variables
    // Begin mtask footprint all: 
    WData/*95:0*/ __Vtemp3477[3];
    WData/*95:0*/ __Vtemp3478[3];
    // Body
    VL_EXTEND_WI(67,4, __Vtemp3477, (((IData)(vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__subsystem_l2_wrapper__DOT__l2__DOT__monitor__DOT___a_first_T) 
                                      & (0U == (IData)(vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__subsystem_l2_wrapper__DOT__l2__DOT__monitor__DOT__a_first_counter_1)))
                                      ? (1U | ((IData)(vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__subsystem_l2_wrapper__DOT__InclusiveCache_inner_TLBuffer__DOT__bundleOut_0_a_q_io_deq_bits_size) 
                                               << 1U))
                                      : 0U));
    VL_SHIFTL_WWI(67,67,6, __Vtemp3478, __Vtemp3477, 
                  ((IData)(vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__subsystem_l2_wrapper__DOT__InclusiveCache_inner_TLBuffer__DOT__bundleOut_0_a_q_io_deq_bits_source) 
                   << 2U));
