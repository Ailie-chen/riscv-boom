...
class VTestHarness__Syms : public VerilatedSyms {
  public:
    ...
    VerilatedScope __Vscope_TestHarness__chiptop__system__tile_prci_domain__tile_reset_domain__boom_tile__core__csr_exe_unit;
    VerilatedScope __Vscope_TestHarness__chiptop__system__tile_prci_domain__tile_reset_domain__boom_tile__core__csr_exe_unit__ifpu;
